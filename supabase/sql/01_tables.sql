...
create table if not exists public.products (
  ...
  receipt_check_only boolean not null default false,
...
create index if not exists products_receipt_check_only_idx on public.products (receipt_check_only) where receipt_check_only = true;
